...
#ifdef CONFIG_CMD_SF
  #undef CONFIG_CMD_SF
#endif //CONFIG_CMD_SF, M3_shuttle_MID has no SPI nor flash on board
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"normal_name=boot\0" \
	"normal_start=0xc00000\0" \
	"normal_size=0x400000\0" \
	"recovery_name=recovery\0" \
	"recovery_start=0x700000\0" \
	"recovery_size=0x500000\0" \
	"recovery_path=uImage_recovery\0" \
	"logo_name=logo\0" \
	"logo_start=0x100000\0" \
	"logo_size=0x300000\0" \
	"aml_logo_name=aml_logo\0" \
	"aml_logo_start=0x400000\0" \
	"aml_logo_size=0x180000\0"
...
#define DDR_TYPE_IDENTIFY  "ddr type: K4B2G1646C\n"

#define CONFIG_SYS_MEMTEST_SCRATCH  (CONFIG_SYS_MEMTEST_START+PHYS_MEMORY_SIZE-4)
