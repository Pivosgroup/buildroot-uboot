...
#define CONFIG_M2_USBPORT_BASE  0xC90C0000
...
#define CONFIG_EXTRA_ENV_SETTINGS \
    ...
    "recoveryargs=nand info;setenv bootargs mem=${memsize} recoverymode=${recoverymode} console=${console}\0" \
    "nandboot=echo Booting from nand ...; run nandargs; nand read ${loadaddr} 1800000 800000; bootm ${loadaddr}\0" \
    "console=ttyS0,115200n8\0" \
    "cpuclock=600M\0" \
    "bootargs=mem=512M a9_clk=600M clk81=187500k mac=00:01:22:65:04:88 console=ttyS0,115200n8\0" \
    "nandargs=nand info;setenv bootargs mem=${memsize} a9_clk=${cpuclock} clk81=${gpuclock} mac=${ethaddr}  console=${console}\0" \
...
#define DDR3_7_7_7
	...
	#error "Please set DDR3 property first in file hisense_tv.h\n"
#endif
...
#define M2C_DDR3_512M
	...
	#error "Please set DDR3 capacity first in file hisense_tv.h\n"
#endif
...
#else
	#error "Please define DDR3 memory capacity in file hisense_tv.h\n"
#endif
