...
static int init_pctl_ddr3(struct ddr_set * ddr_setting);
	...
	#define DDR3_2Gbx16
#else
	#error "Please define DDR3 memory capacity first in file hisense_tv.h!\n"
#endif
...
//trunk/include/configs/amlogic/aml_tv_m2c.h
...
static struct ddr_set __ddr_setting={
         ...
         .init_pctl=init_pctl_ddr3
                    ...
                    .t_mrd          =   4,
                    .t_1us_pck      =  96, //132 for 528MHz, 120 for 480MHz
                    .t_100ns_pck    =  14,
                    .t_init_us      = 511,
                    .t_ras          =  20,
                    .t_rc           =  27,
         ...
         .ddr_pll_cntl=0x00110220, //0x0011022c is 528MHz   0x00110228 is 480MHz
         .ddr_clk=480,
         .ddr_ctrl= (0 << 24 ) |    //pctl_brst 4,
                    (0xff << 16) |  //reorder en for the 8 channel.
                    (0 << 15 ) |     // pctl16 mode = 0.  pctl =   32bits data pins
...
//                     .ddr_clk=400,
                     ...
                     .init_pctl=init_pctl_ddr3
#else
	#error "Please define DDR3 type in file hisense_tv.h!\n"
#endif         
};
